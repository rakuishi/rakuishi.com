...
<img style="display:block; margin-left:auto; margin-right:auto;" src="/images/2012/12/20121206210634.png" alt="20121206210634" title="20121206210634.png" border="0" width="320" height="568" />
...
<img style="display:block; margin-left:auto; margin-right:auto;" src="/images/2012/12/20121206212532.png" alt="20121206212532" title="20121206212532.png" border="0" width="320" height="568" />
...
<img style="display:block; margin-left:auto; margin-right:auto;" src="/images/2012/12/e5d5f702a5d8f192e410a87e316cd4e8.png" alt="IOSシミュレータのスクリーンショット" title="iOSシミュレータのスクリーンショット .png" border="0" width="320" height="568" />

ちなみに、Interface Builder で、テーブルビューを貼りつけている場合は、サイズインスペクタから、この余白設定を行えます。

<img style="display:block; margin-left:auto; margin-right:auto;" src="/images/2012/12/sizeinspector.png" alt="Sizeinspector" title="sizeinspector.png" border="0" width="261" height="278" />

また、UIWebView も次のようにすれば、余白を設定できます。

<pre class="prettyprint">    webView.scrollView.contentInset = UIEdgeInsetsMake(0.f, 0.f, 44.f, 0.f);
...
<img style="display:block; margin-left:auto; margin-right:auto;" src="/images/2012/12/20121206214742.png" alt="20121206214742" title="20121206214742.png" border="0" width="320" height="568" />
